...
<!-- CSS Files -->
<link id="pagestyle"
	href="<c:url value="/static/css/material-dashboard.css"/>"
	rel='stylesheet' />
<!--     Fonts and icons     -->
<link rel="stylesheet" type="text/css"
	href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700" />
...
<!-- Favicon -->
<link rel="icon" type="image/png" sizes="18x18"
	href="../resources/images/univlogo.png">
...
<script src="https://kit.fontawesome.com/95401d2f49.js"
	crossorigin="anonymous"></script>
...
<script type="text/javascript"
	src="<c:url value="/static/js/clock.js"/>"></script>


<!-- calendar -->
<link href="<c:url value="/static/css/calendar.css"/>" rel='stylesheet' />
<script type="text/javascript"
	src="<c:url value="/static/js/calendar.js"/>"></script>
