            ...
            <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                    	<li><a href="<c:url value='/board/cat/1'/>"><fmt:message key="BULLETIN_BOARD"/></a>
                        <li><a href="<c:url value='/board/cat/2'/>"><fmt:message key="BOARD"/></a>
                        <li><a href="<c:url value='/board/cat/3'/>"><fmt:message key="GALLERY"/></a>
					</ul>
				</li>
                <li class="dropdown">
