							...
							<div class="card-body px-0 pb-2">
								<div class="m-5">
									...
									<div class="form-group">
										...
										value="${sessionScope.userName}" ${!empty sessionScope.userName ? "readonly" : "" } required>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-1" for="email"><fmt:message key="EMAIL"/></label>
										<input type="text" name="email" id="email"
										style="color:gray; background-color:#f0f0f0; border:1px solid gray;" 
										value="${sessionScope.email}" ${!empty sessionScope.email ? "readonly" : "" } required>
									</div>
									...
									<div class="form-group">
								      <label class="control-label  col-sm-1" for="title"><b><fmt:message key="TITLE"/></b></label>
								       <input type="text" name="title" id="title" style="width:85%; border:1px solid gray;"placeholder="게시글 제목" required>
								    </div>
								    <div class="form-group px-3">
								     <label class="control-label" for="content"><b><fmt:message key="CONTENT"/></b></label>
								      <div class="m-1 p-0">
								        <textarea name="content" rows="15" cols="200" class="form-control" placeholder="게시글 입력"></textarea>
								      </div>
								    </div>
								    <div class="form-group p-3"> 
								      <label class="control-label" for="photo"><fmt:message key="FILE"/> : <fmt:message key="FILESIZE_ERROR"/></label>
								      <div >
