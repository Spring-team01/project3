												...
												<tbody>
													<c:forEach var="community" items="${communityList}">
														<tr>
															...
															<td>
																<h6 class="mb-0 text-sm">${community.communityTitle}</h6>
															</td>
											...
											<div class="pager d-flex justify-content-center my-3">
												...
												<div class="pagingButtonSet d-flex justify-content-center col-5">
													<c:if test="${pager.pageNo > 1}">
														<a href="1" type="button" class="btn btn-muted shadow">처음</a>
													</c:if>

													<c:if test="${pager.groupNo > 1}">
														<a href="${pager.startPageNo-1}" type="button" class="btn btn-muted shadow">앞</a>
													</c:if>
													...
													<c:if test="${pager.groupNo < pager.totalGroupNo }">
														<a href="${pager.endPageNo+1}" type="button" class="btn btn-muted shadow">뒤</a>
													</c:if>
													<a href="${pager.totalPageNo}" type="button" class="btn btn-muted shadow">마지막</a>
												</div>
												<div class="flex-fulfill"></div>
											</div>
										</div>
